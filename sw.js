...
const CACHE = 'pastizzi-v14';
const ASSETS = ['.', 'index.html', 'css/styles.css', 'js/game.js', 'manifest.json', 'icons/icon-192.png', 'icons/icon-512.png', 'js/lib/confetti.min.js', 'assets/logo.png'];

...
const CACHE = 'pastizzi-v28';
const ASSETS = ['.', 'index.html', 'css/styles.css', 'js/game.js', 'manifest.json', 'icons/icon-192.png', 'icons/icon-512.png', 'js/lib/confetti.min.js', 'assets/logo.png', 'assets/p-irkotta.png', 'assets/p-pizelli.png', 'assets/pizza.png', 'assets/imqaret.png', 'assets/qaghaq.png', 'assets/figolla.png', 'assets/voice-title.mp3', 'assets/voice-mela.mp3', 'assets/voice-prosit.mp3', 'assets/voice-nomatch.mp3', 'assets/menu1.mp3', 'assets/menu2.mp3', 'assets/menu3.mp3'];
